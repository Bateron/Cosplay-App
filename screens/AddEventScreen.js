...
export default function AddEventScreen({ route, navigation }) {
  ...
  // cosplayId and cosplayName passed from CosplayCard
  ...
  return (
    <Container style={[styles.container, { backgroundColor: theme.background }]}>
      <ScrollView
        style={{ flex: 1 }}
        contentContainerStyle={{ flexGrow: 1, paddingHorizontal: spacing[4], paddingVertical: spacing[4], paddingBottom: spacing[8] }}
      ...
      >
        ...
        <View style={{ backgroundColor: theme.surfaceLight, borderRadius: borderRadius.xl, padding: spacing[4], marginBottom: spacing[6], ...shadows.md }}>
          <Text style={{ fontSize: fontSize.lg, fontWeight: fontWeight.bold, color: theme.primary, marginBottom: spacing[4] }}>
            Event Details
          </Text>
